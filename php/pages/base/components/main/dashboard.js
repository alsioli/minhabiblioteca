let dashboard = {
    ...
    carregarAndamento: async function () {
        ...
        try {
                ...
                <table style="width:100%;border-collapse:collapse;font-size:0.82rem">
                    <thead style="background:#f8f9fa">
                        <tr>
                            ...
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6;text-align:center">Progresso</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6"></th>
                        </tr>
                    </thead>
                    <tbody>`;
            ...
            lista.forEach(function (l) {
                ...
                let diasCor = dias > 30 ? '#c62828' : (dias > 15 ? '#e65100' : '#2e7d32');
                let diasBg  = dias > 30 ? '#ffebee' : (dias > 15 ? '#fff3e0' : '#e8f5e9');
                ...
                <table style="width:100%;border-collapse:collapse;font-size:0.82rem">
                    <thead style="background:#f8f9fa">
                        <tr>
                            ...
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Título</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Autor</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6;text-align:center">Págs</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Status</th>
                        </tr>
                    </thead>
                    <tbody>`;
            ...
            let html = `<div>
                <table style="width:100%;border-collapse:collapse;font-size:0.82rem">
                    <thead style="background:#f8f9fa">
                        <tr>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Título</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">LC</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6;text-align:center">Vencimento</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Situação</th>
                        </tr>
                    </thead>
                    <tbody>`;
    ...
    carregarFavoritos2025: async function () {
        ...
        try {
            ...
            if (!json.status || !json.data || json.data.length === 0) {
                this._vazio(id, 'Nenhum favorito em 2025 ainda.');
                return;
            }
                ...
                <table style="width:100%;border-collapse:collapse;font-size:0.82rem">
                    <thead style="background:#f8f9fa">
                        <tr>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Título</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Autor</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6;text-align:center">Lido em</th>
                        </tr>
                    </thead>
                    <tbody>`;
            ...
            lista.forEach(function (l) {
                html += `<tr style="border-bottom:1px solid #f0f0f0">
                    ...
                    <td style="padding:3px 6px;text-align:center;white-space:nowrap">${l.mes_leitura || '—'}</td>
                </tr>`;
            });
            ...
            console.error('carregarFavoritos2025:', e);
    ...
    carregarTbrEmBreve: async function () {
        ...
        try {
            ...
            if (!json.status || !json.data || json.data.length === 0) {
                this._vazio(id, 'Nenhum livro no TBR do mes atual.');
                return;
            }
                ...
                <table style="width:100%;border-collapse:collapse;font-size:0.82rem">
                    <thead style="background:#f8f9fa">
                        <tr>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Título</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Autor</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Origem</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Quando</th>
                        </tr>
                    </thead>
                    <tbody>`;
                ...
                <table style="width:100%;border-collapse:collapse;font-size:0.82rem">
                    <thead style="background:#f8f9fa">
                        <tr>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Título</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Autor</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Tema</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6;text-align:center">Prioridade</th>
                        </tr>
                    </thead>
                    <tbody>`;
                ...
                <table style="width:100%;border-collapse:collapse;font-size:0.82rem">
                    <thead style="background:#f8f9fa">
                        <tr>
                            ...
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Título</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Autor</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Natureza</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6;text-align:center">Data Compra</th>
                        </tr>
                    </thead>
                    <tbody>`;
    ...
    // ─── Leituras Previstas para o Mês (TBR) ────────────────────
    carregarPrevisoesmes: async function () {
        const id = 'bloco-previsoes';
        this._carregando(id);
        try {
            const resp = await fetch('/php/api/base/main/livros/listar_previsoes_mes.php');
            const json = await resp.json();

            if (!json.status || !json.data || json.data.length === 0) {
                this._vazio(id, 'Nenhuma leitura prevista para os próximos dias.');
                return;
            }
                ...
                <table style="width:100%;border-collapse:collapse;font-size:0.82rem">
                    <thead style="background:#f8f9fa">
                        <tr>
                            ...
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Autor</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Origem</th>
                            <th style="padding:4px 6px;border-bottom:1px solid #dee2e6">Previsão</th>
                        </tr>
                    </thead>
                    <tbody>`;
            ...
            lista.forEach(function (l) {
                html += `<tr style="border-bottom:1px solid #f0f0f0">
                    ...
                    <td style="padding:3px 6px;max-width:120px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${l.autor || '—'}</td>
                    <td style="padding:3px 6px;white-space:nowrap">${l.origem || '—'}</td>
                    <td style="padding:3px 6px;font-size:0.78rem;color:#555;white-space:nowrap">${l.previsao_leitura || '—'}</td>
                </tr>`;
            });
            ...
            console.error('carregarPrevisoesmes:', e);
            this._erro(id, 'Erro ao carregar previsões do mês.');
        }
    },
